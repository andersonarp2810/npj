...
@section('component')
  <div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <form action="{{URL::to('Professor/Peticao/Editar')}}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
            ...
            @foreach($photos as $photo)
              ...
              <div class="col-3 mb-3">
                <div class="text-center">
                  ...
                  @endif
                  <br>
                  <button type="button" class="btn btn-sm btn-danger mt-1" onClick="location.href='{{URL::to('Professor/Peticao/Edit/' . $petition->id . '/DeletePhoto/' . $photo->id )}}'">
