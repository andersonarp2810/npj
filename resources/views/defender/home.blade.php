  ...
  <div class="row justify-content-center mt-3">
    ...
    <div class="row justify-content-center mt-3">
      ...
      <div class="col-lg-4 col-md-4 col-12 mb-3">
        @cardHome(['items' => ['title' => 'ALUNO', 'icon' => 'fa-user', 'color' => 'bg-primary']])
          {{$petitions->where('defender_id',$defender->id)->where('student_ok','!=','true')->count()}}
        @endcardHome
      </div>
      
      <div class="col-lg-4 col-md-4 col-12">
        @cardHome(['items' => ['title' => 'DEFENSOR', 'icon' => 'fa-user-tie', 'color' => 'bg-primary']])  
          {{$petitions->where('defender_id',$defender->id)->where('defender_ok','!=','true')->where('teacher_ok','true')->where('student_ok','true')->count()}}
        @endcardHome
      </div>
      
      <div class="col-lg-4 col-md-4 col-12">
        @cardHome(['items' => ['title' => 'DISPONÍVEIS', 'icon' => 'fa-user-tie', 'color' => 'bg-primary']])  
    ...
    <div class="row justify-content-center mt-3">
      ...
      <div class="col-lg-4 col-md-6 mb-3">
        @cardHome(['items' => ['title' => 'RECUSADAS', 'icon' => 'fa-user-graduate', 'color' => 'bg-danger']])  
          {{$petitions->where('defender_id',$defender->id)->where('defender_ok','false')->count()}}
        @endcardHome
      </div>
      
      <div class="col-lg-4 col-md-6 mb-3">
        @cardHome(['items' => ['title' => 'FINALIZADAS', 'icon' => 'fa-check', 'color' => 'bg-success']])  
