...
<body>
  ...
  <div class="sidenav" style="width:15%;height:110%">
    <header class="sidebar-header" style="background:white;border: 6px groove #ddd !important;">
      <span class="logo">
        <a href="{{URL::to('Professor')}}"><h6 style="font-family:verdana;color:red">NPJ-Sistema</h6></a>
      </span>
    </header>
    ...
    <nav class="sidebar-navigation">
      ...
      <hr>
      <li class="menu-item">
        <a class="menu-link"  href="{{URL::to('Professor/Duplas')}}">
          <span class="title" style="font-size:20px">DUPLAS</span>
        </a>
      </li>
      </hr>
      <hr>
      <li class="menu-item">
        <a class="menu-link"  href="{{URL::to('Professor/Peticoes')}}">
      ...
      <hr>
      <li class="menu-item">
        <a class="menu-link"  href="{{URL::to('Professor/Templates')}}">
          <span class="title" style="font-size:20px">TEMPLATES</span>
        </a>
      </li>
      </hr>
      <br><br><br><br><br>
        <hr>
          <li class="menu-item">
            <a href="{{URL::to('Professor/Preferencias')}}">
